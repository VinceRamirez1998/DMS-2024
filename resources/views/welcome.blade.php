...
<div class="grid grid-cols-6 lg:gap-x-4 pt-2 px-5">
  ...
  <form action="" method="POST">
    ...
    <button type="button" id="newsButton" class="bg-red-900 flex-grow p-3 py-1 text-white border-solid border-r-2 border-rose-900" style="padding-left: 8px; padding-right: 0px; white-space: nowrap;">News & Events</button>
